...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(String location){
         URL mUrl = buildUrl(location);
         new getWeatherData().execute(mUrl);
    }
    ...
    class getWeatherData extends AsyncTask<URL,Void,String>{
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                weatherData = getResponseFromHttpUrl(weatherUrl);

                String[] simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,weatherData);
